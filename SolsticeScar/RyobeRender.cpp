	...
	: RenderComponent(gameObject)
{
	...
	createSpriteAnim(sf::IntRect(200,2400,200,200), "TeleportIn", false,3,3);
	...
	createSpriteAnim(sf::IntRect(200,2200, 200, 200),"FellCrescent", false, 12, 3, 3);
	createSpriteAnim(sf::IntRect(200,2600, 200, 200),"Dead", false, 6, 3, 3);
