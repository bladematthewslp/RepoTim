...
std::string Attacks::NINJA_SLASH_GROUND		= "NINJA_SLASH_GROUND",
			...
			Attacks::PLAYER_HAILBRINGER		= "PLAYER_HAILBRINGER",
...
AttackType::AttackType(DamageType damageType, bool canLaunch, std::string name, bool isAirAttack, bool canSendToGround)
	: mDamageType(damageType)
	, mCanLaunch(canLaunch)
	, mName(name)
	, mIsAirAttack(isAirAttack)
	, mCanSendToGround(canSendToGround)
{
