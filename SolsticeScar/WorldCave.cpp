...
WorldCave::WorldCave(Scene::Context& context )
	: World(context)
{
	// init stuff here
...
void WorldCave::init()
{
	...
	mGrid = std::unique_ptr<Grid>(new Grid(Maps::Cavern, 64)).release();
...
/*
bool WorldCave::handleEvent(sf::RenderWindow& window, sf::Event& event)
{
...
*/
/*
bool WorldCave::handleInput(sf::Event& event)
{
...
unsigned int WorldCave::update(sf::Time dt)
{
